    ...
    return (
        <section className="popular-tastes">
            ...
            {data ?
                ...
                :
                <div style={{ display: "flex", justifyContent: "center", alignItems: "center", marginTop: "180px", marginBottom: "180px" }}>
                    <Loader2 className="infinity-rotate" width={40} height={40} color="white"></Loader2>
                </div>}
            {/* <li className="popular-tastes-item">
                ...
                <li className="popular-tastes-item">
                    ...
                    <h3 className="popular-tastes-title">Голубика</h3>
                    <p className="popular-tastes-description">
                        Крем-брюле<br />
                        с черничным джемом
                    </p>
