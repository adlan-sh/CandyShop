            ...
            <nav className="navigation">
                ...
                <ul className="navigation-list navigation-user">
                    ...
                    <li className="navigation-item">
                        ...
                        <div className="popover popover-search popover-close" >
                            <input type="text" placeholder="Поиск по сайту" />
                            <button className="popover-search-button-close" type="button" hidden>
                            ...
                            <div className="popover popover-entry ">
                                ...
                                <form className="popover-entry-form">
                                    ...
                                    <div className="popover-entry-info">
                                        ...
                                        <a className="popover-link" href="#">Регистрация</a>
                                    </div>
                                </form>
                            </div>
                        </Popover>
