...
const Footer = () => {
    return (
        <footer className="main-footer">
            <ul className="bestesller-container-contacts">
                ...
                <li className="contacts-item">
                    <a className="contacts-link" href="https://www.facebook.com/htmlacademy">
                        <svg className="contacts-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M24 12a12 12 0 1 1-24 0 12 12 0 0 1 24 0Zm-9.6.9H13V18h-2.3v-5.1H9v-2.4h1.7V8.8C10.7 7 11.8 6 13.4 6H15v2.1h-.9c-1.1 0-1.1.6-1.1 1.2v1.2h2l-.6 2.4Z"
            ...
            <div>
                <p className="created-by">Сделано в <a className="htmlacademy-href" href="">422 кабинете</a> © 2024</p>
            </div>
        </footer>
    )
}
